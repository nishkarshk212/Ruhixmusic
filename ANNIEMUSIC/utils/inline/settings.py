...
def setting_markup(_):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="Sᴋɪᴘ Pᴇʀᴍ", callback_data="SKIP_PERM"),
        ],
        [
...
def skip_perm_markup(_, current_perm: str = "admin"):
    buttons = [
        [
            InlineKeyboardButton(
                text=f"{'✅' if current_perm == 'admin' else ''} Aᴅᴍɪɴs",
                callback_data="set_skip_admin",
            ),
        ],
        [
            InlineKeyboardButton(
                text=f"{'✅' if current_perm == 'member' else ''} Mᴇᴍʙᴇʀs",
                callback_data="set_skip_member",
            ),
        ],
        [
            InlineKeyboardButton(
                text=f"{'✅' if current_perm == 'everyone' else ''} Eᴠᴇʀʏᴏɴᴇ",
